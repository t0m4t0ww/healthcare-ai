...
/**
 * Xuất record ra PDF (legacy - POST method)
 * @param {string} recordId - ID record
 ...
 * @returns {Promise<Blob>} PDF blob
 */
export const exportRecordPDF = async (recordId, options = {}) => {
  try {
    ...
    console.error('Failed to export record PDF:', error);
